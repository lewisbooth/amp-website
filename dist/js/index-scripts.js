...
if (html.classList.contains("no-touch") && window.innerWidth > 1020) {
  ...
  var scene3 = new ScrollMagic.Scene({ triggerElement: "#card3" }).setTween(tween3).addTo(controller);

  // Scene 4
  var tween4 = TweenMax.staggerFromTo("#text4", 1, { x: 150, opacity: 0 }, { x: 0, opacity: 1 }, 1);

  var scene4 = new ScrollMagic.Scene({ triggerElement: "#card4" }).setTween(tween4).addTo(controller);
}
