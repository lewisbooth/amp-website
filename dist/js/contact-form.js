...
$(document).ready(function () {
  $('form').submit(function (e) {
    ...
    $.ajax({
      ...
      if (data.success === true) {
        $('.contact form button').removeClass('processing').addClass('success');
        $('#form-reset-text').text('Send another message');
        $('#form-reset-container').addClass('active');
      } else {
        $('.contact form button').removeClass('processing').addClass('failed');
  ...
  $('#form-reset-container').click(function () {
    $('form input').val('');
    $('form textarea').val('');
  ...
  function checkFormInputs() {
    if ($('#form-name').hasClass('valid') && $('#form-email').hasClass('valid') && $('#form-message').hasClass('valid')) {
